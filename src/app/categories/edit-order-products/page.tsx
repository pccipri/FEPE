                            ...
                            <div>
                                ...
                                <form style={{ color: 'black', width: '30vw' }} >
                                    <div className="form-group">
                                        ...
                                        <input type="number" className="form-control" id="OrderId" placeholder="OrderId" min={0}/>
                                    </div><br />
                                    <div className="form-group">
                                        <label htmlFor="exampleInputEmail1">Product Id</label>
                                        <input type="number" className="form-control" id="ProductId" placeholder="ProductId" min={0}/>
                                    </div><br />
                                    <div className="form-group">
